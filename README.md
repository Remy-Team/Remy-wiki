...
## Дополнение от 15.03.2024
- Умное обновление контента
- Down-scaling Upscalong одного и того же ресурса. Обновление не всей картинки на сервер, обновилась только часть контента.
- Пайплайн по обработке: Processing через шину вынесен с брокером сообщением с image processing
- Even driven
